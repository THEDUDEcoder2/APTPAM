...
public class Trabajador {
    ...
    public String getConocimientosHerramientas() { return conocimientosHerramientas; }
    public void setConocimientosHerramientas(String conocimientosHerramientas) { this.conocimientosHerramientas = conocimientosHerramientas; }
    ...
    public List<TrabajadorIdioma> getTrabajadorIdiomas() { return trabajadorIdiomas; }
    ...
    public String getDomicilioCompleto() {
        ...
        if (calle != null && !calle.isEmpty()) domicilio.append(calle);
